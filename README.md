  ...
  * Software Development and Administration  
    ...
    * Programming Languages  
      ...
      * Python  
        ...
        * Python Packages  
          * [AWS Chalice - Python Serverless Microframework for AWS 1.12.0 documentation](https://chalice.readthedocs.io/en/latest/)  
          * [Atlassian Python API 1.13.23 documentation](https://atlassian-python-api.readthedocs.io/en/latest/)  
          ...
          * [atlassian-python-api/examples at master · atlassian-api/atlassian-python-api](https://github.com/atlassian-api/atlassian-python-api/tree/master/examples)  
          * [awsdocs/aws-doc-sdk-examples: Welcome to the AWS Code Example Repository.](https://github.com/awsdocs/aws-doc-sdk-examples)  
